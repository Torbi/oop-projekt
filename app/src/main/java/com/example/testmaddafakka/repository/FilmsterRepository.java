...
public class FilmsterRepository implements IApiListener {
    ...
    public void updateSearch(List<IMedia> searchResults){
    ...
    public void search(String name){
        ...
        imdbAdapter.getSearchResult(name); // Create new getList for searchResults
    }
...
>>>>>>> c6080ea (working on fixing the search)
=======
package com.example.testmaddafakka.repository;
...
public class FilmsterRepository implements IApiListener {
    ...
    public void update(List<IMedia> medias) {
        if(!isSearchResults){
            ...
            System.out.println("update search sa dja");
...
public class FilmsterRepository implements IApiListener {
    ...
    public void loadSearchedNameMedias(String id){
        //imdbAdapter.setBuildRequestStrategy();
    }
}
>>>>>>> d2dc153 (you can now search for an actor)
